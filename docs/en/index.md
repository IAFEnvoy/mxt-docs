...
| Creature Profiles and Contracts | 🚧 | Creature profiles define a creature's strength, inner core and the action it runs on spawn; players can sign a contract with a creature and order it to follow, wander, hold or come back with the Beast Taming Bell, or carry it in a Spirit Beast Bag. |
